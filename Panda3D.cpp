...
void Panda3D::EnableKeyboard()
{
    //framework.define_key("w", "w-repeat", MoveCameraForward, (void*) 0);
}

void Panda3D::displayScene()
{
    ...
    //GameObject gameobject(window, "models/panda-model");
