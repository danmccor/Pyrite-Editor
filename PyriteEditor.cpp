...
void PyriteEditor::New()
{
	...
	QFile saveFile(QFileDialog::getSaveFileName(this, "Create New Project", "", "Pyrite Project (*.pyr)"));
...
void PyriteEditor::SaveAs()
{
	...
	QFile saveFile(QFileDialog::getSaveFileName(this, "Save Project", "", "Pyrite Project (*.pyr)"));
	if (!saveFile.open(QIODevice::WriteOnly)) {
		qWarning("Couldn't open save file.");
	}
...
{
	QString fileName = QFileDialog::getOpenFileName(this, "Open Project","","Pyrite Project (*.pyr)");
